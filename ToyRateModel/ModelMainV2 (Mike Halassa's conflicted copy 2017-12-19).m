...
%% Connection Weights >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
% Wep =  to e from
W11 = 0.987;    W12 = 0;        W13 = 0.0412;   W14 = 0;       W15 = -0.65;     W16 = 0; % inputs to epop1 (pfc 1)
W21 = 0;        W22 = 0.987;    W23 = 0.0412;   W24 = -0.65;   W25 = 0;         W26 = 0;   % inputs to epop2 (pfc 2)
W31 = 1.385;    W32 = 1.385;    W33 = 0;        W34 = 0;       W35 = 0;         W36 = -1.985;    % inputs to epop3 (thal)
...
W61 = 1.285;    W62 = 0 ;       W63 = 0.00;     W64 = 0;       W65 = 0;         W66 = 0; % inputs to ipop4 (trn)
...
NumTrials = 30;
NumModels = 1; % number of models to simulate;
...
for trial = 1:NumTrials
    ...
    if trialType ==  1
        ...
        ind1 = find( time >= 0 & time <= 100 );
        
        Y = genrateGamCurrent(100);
        
        Istim1( ind1  )  =  Istim1_amp.*Y;
    ...
    elseif trialType == 3
        ...
        ind1 = find( time >= 0 & time <= 100 );
        ind2 = find( time >= 500 & time <= 600 );
        
        Y = genrateGamCurrent(100);
        
        Istim1( ind1  )  =  Istim1_amp.*Y;
        Istim1( ind2  )  =  Istim1_amp.*Y;
    ...
    for t = 1:length(time)-1
        ...
        I1 = W(1,1).*r_1(t) + W(1,2).*r_2(t) + W(1,3).*r_3(t) + W(1,4)*r_4(t) + W(1,5)*r_5(t)+ W(1,6)*r_6(t)+  Istim1(t) + I1_b(t);
        I2 = W(2,1).*r_1(t) + W(2,2).*r_2(t) + W(2,3).*r_3(t) + W(2,4)*r_4(t) + W(2,5)*r_5(t)+ W(2,6)*r_6(t)+  Istim2(t) + I2_b(t);
        I3 = W(3,1).*r_1(t) + W(3,2).*r_2(t) + W(3,3).*r_3(t) + W(3,4)*r_4(t) + W(3,5)*r_5(t)+ W(3,6)*r_6(t)+  I3_b(t) + Istim2(t) + Istim1(t);
        I4 = W(4,1).*r_1(t) + W(4,2).*r_2(t) + W(4,3).*r_3(t) + W(4,4)*r_4(t) + W(4,5)*r_5(t)+ W(4,6)*r_6(t)+  I4_b(t);
        I5 = W(5,1).*r_1(t) + W(5,2).*r_2(t) + W(5,3).*r_3(t) + W(5,4)*r_4(t) + W(5,5)*r_5(t)+ W(5,6)*r_6(t)+  I5_b(t);
    ...
    if trialType == 1
        subplot(1,4,1);
        plot( time, r_3, 'r'); hold on;
    elseif trialType == 2
        subplot(1,4,2);
        plot( time, r_3, 'g'); hold on;
    elseif trialType == 3
        subplot(1,4,3);
        plot( time, r_3, 'b'); hold on;
    elseif trialType == 4
        subplot(1,4,4);
